...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 24, 2022 at 03:57 AM
...
(1, 'Andi', '0851178878', 'Paris'),
(2, 'Budi', '0851197531', 'Jakarta'),
(3, 'Cindy', '0851108642', 'Tokyo');
...
INSERT INTO `pesanan` (`idorder`, `tanggal`, `iduser`, `idpelanggan`) VALUES
(1, '2022-09-22 23:03:15', 0, 1),
(3, '2022-09-22 23:04:22', 0, 2);
...
(1, 'Buku', 'B.Inggris', 50000, 28),
(2, 'Kamus', 'B.Arab', 10000, 49),
(3, 'Pensil Warna', 'Fabber Castell', 40000, 50);
