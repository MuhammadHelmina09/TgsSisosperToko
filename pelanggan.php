                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <div class="modal-body">
                                                            <input type="text" name="namapelanggan" class="form-control" placeholder="Nama Prelanggan" value="<?= $namapelanggan; ?>">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <!-- Modal body -->
                                                        <div class="modal-body">
                                                            Apakah Anda Yakin Menghapus Pelanggan ini?
                                                            <input type="hidden" name="idpl" value="<?= $idpl; ?>">
                                                        </div>
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid px-4">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Copyright &copy; Muhammad Helmina</div>
                    </div>
                </div>
            </footer>
        </div>
